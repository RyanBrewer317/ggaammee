  ...
  for (let y = 0; y < REGION_HEIGHT; y++) {
    for (let x = 0; x < REGION_WIDTH; x++) {
      ...
      if (block === 'D') {
        ...
        data = gettexture(RegionalMap, x, y, [80, 160, bigrocksheet], [160, 160, bigrocksheet], [0, 160, bigrocksheet], [240, 160, bigrocksheet], [80, 80, bigrocksheet], [160, 80, bigrocksheet], [0, 80, bigrocksheet], [80, 160, smallrocksheet], [80, 239, bigrocksheet], [160, 239, bigrocksheet], [0, 239, bigrocksheet], [240, 139, bigrocksheet], [160, 239, smallrocksheet], [0, 239, smallrocksheet], [240, 79, smallrocksheet], [240, 80, bigrocksheet], ['S', 'T', 'C']);
